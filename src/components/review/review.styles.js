...
export const ReviewContainer = styled.div`
  height: ${props => {
      if (props.collapse && props.expanded) {
        return '375px'
...
export const RatingBarPercentage = styled(RatingBar)`
  transform: scaleX(${props => props.percentage ? props.percentage / 100 : 1});
  transform-origin: left;
  background-color: ${props => props.percentage ? 'dodgerblue' : props.theme.main};
