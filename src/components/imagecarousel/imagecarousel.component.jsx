...
import { Fader, ImageCarouselContainer, ImageCarouselSlide } from './imagecarousel.styles'
const images = [
...
const ImageCarousel = () => {
      ...
      useEffect(() => {
            ...
            images.forEach(el => {
                  let img = new Image()
                  img.onload = () => {
                        loadedImages.push(<img style={{maxHeight: '100%', maxWidth: '100%', objectFit: 'cover'}} src={el} alt='nature background'/>); 
                  }
