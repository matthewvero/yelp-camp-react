...
import { NoProfileImage, ProfilePictureContainer} from './profilepicture.styles'
...
const ProfilePicture = () => {
      ...
      return (
            ...
            <InputImage setImageFn={updateProfileImage} id='profileImage'/>

            {
                  ...
                  : 
                  <NoProfileImage>
                        <FontAwesomeIcon style={{position: 'absolute',fontSize: '7rem', color: themeContext.main}} icon={faUser}/>
                  </NoProfileImage> 
            }
            </ProfilePictureContainer>
      )
