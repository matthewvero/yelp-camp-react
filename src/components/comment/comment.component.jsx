...
const Comment = ({data, userID}) => {
      ...
      const handleDelete = () => {
            const ans = window.confirm('Are you sure you would like to delete this comment?');
            ans && 
      ...
      return (
            <React.Fragment>
                  <div style={{height: 'auto', display: 'flex', flexWrap: 'wrap', justifyContent: 'flex-start', width: '100%'}}>
                        ...
                        {
                              userID === data.user &&
                              <div style={{marginLeft: 'auto', color: 'white', display: 'flex'}}>
                                    {
                                          editing &&
                                          <Button fn={handleUpdate} style={{...inputButtonStyle, backgroundColor: theme.color}}>Update</Button>
                                    }
                                    {
                                          editing ?
                                          <Button 
                                          ...
                                          <React.Fragment>
                                                ...
                                                <Button 
                                                      style={{...inputButtonStyle, color: 'rgb(255, 100, 100)'}}
                                                      fn={handleDelete}
                                                >
                                                      Delete
                                                </Button>
